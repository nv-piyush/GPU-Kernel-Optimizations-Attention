#!/bin/bash
# benchmarks/run_sweep_week5.sh
#
# Runs all six variants across all 32 configs.
# Variants: baseline | tiled | softmax_fixed | fused |
#           warp_softmax | tiled32
...
OUT="results/week5/full_sweep.csv"
WARMUP=5
ITERS=100
